...
class Tree (Gtk.VBox, GObject.GObject):
    ...
    def __init__(self, base_path="."):
        ...
        self.__setup_icons(os.path.abspath('pixmaps/rss.png'), 'feed')
        self.__setup_icons(os.path.abspath('pixmaps/logo2.svg'), 'logo')
        self.__setup_icons(os.path.abspath('pixmaps/feed-missing.svg'), 'missing')
        self.__setup_icons(os.path.abspath('pixmaps/starred.svg'), 'starred')
